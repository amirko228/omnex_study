        ...
        <div className="flex items-center gap-8">
          ...
          <div className="hidden lg:flex items-center gap-10">
            ...
            <button
              ...
              className={`text-sm transition-colors hover:text-foreground ${currentPage === 'pricing' ? 'text-foreground font-semibold' : 'text-muted-foreground'
                }`}
            >
              {dict.nav.pricing}
            </button>
            ...
            {user && (
              ...
              >
                ...
                {locale === 'ru' ? 'Создать с ИИ' : 'Create with AI'}
              </button>
            )}
          </div>
        </div>
          ...
          >
            <div className="container mx-auto px-4 py-4 space-y-3">
              ...
              <button
                ...
                className={`w-full text-left px-4 py-3 rounded-lg transition-colors ${currentPage === 'pricing'
                  ? 'bg-primary/10 text-primary font-semibold'
                  : 'hover:bg-muted text-foreground'
                  }`}
              >
