...
export function TermsOfService({ dict }: TermsOfServiceProps) {
  const { termsOfService: t } = dict;
  ...
  return (
    <div className="min-h-screen bg-background">
      <motion.section 
        ...
        className="py-16 bg-gradient-to-br from-green-500/5 via-blue-500/5 to-background"
      >
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ scale: 0.9 }}
            animate={{ scale: 1 }}
            className="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-green-500/10 mb-6"
          >
      ...
      <section className="py-12 container mx-auto px-4 max-w-4xl">
        ...
        >
          ...
          <Card>
            ...
            <CardContent className="space-y-4 text-muted-foreground">
              <p><strong>{t.section3_allowed}</strong></p>
              <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center gap-3 mb-2">
                ...
                <CardTitle>{t.section6_title}</CardTitle>
              </div>
            </CardHeader>
            <CardContent className="space-y-4 text-muted-foreground">
              <p><strong>{t.section6_intro}</strong></p>
              <ul className="list-disc list-inside space-y-2 ml-4">
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center gap-3 mb-2">
                ...
                <CardTitle>{t.section7_title}</CardTitle>
              </div>
            </CardHeader>
            <CardContent className="space-y-4 text-muted-foreground">
              <p>{t.section7_p1}</p>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center gap-3 mb-2">
                ...
                <CardTitle>{t.section8_title}</CardTitle>
              </div>
            </CardHeader>
            <CardContent className="space-y-4 text-muted-foreground">
              <p>{t.section8_p1}</p>
